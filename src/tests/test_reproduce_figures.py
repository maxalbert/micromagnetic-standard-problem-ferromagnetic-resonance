...
from postprocessing import figure2, figure3, figure4_and_5
...
def test_reproduce_figure_3():
    figure3("../../data/oommf/dynamic_txyz.txt", "../../data/oommf/mys_ft_abs.npy", software='OOMMF')


@image_comparison(baseline_images=['figure4_OOMMF', 'figure5_OOMMF'], extensions=['png', 'pdf'])
def test_reproduce_figure_4_and_5():
    figure4_and_5("../../data/oommf/dynamic_txyz.txt",
