...
"The data in this directory was automatically generated by the script 'src/oommf_scripts/generate_data_oommf.sh' in this repository and can safely be deleted." > README.txt
